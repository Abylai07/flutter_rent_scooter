        ...
        OnboardingEntity(
          body: [
            OnboardingBodyEntity(
              ...
              child: const Icon(BikeIcons.check),
            ),
            OnboardingBodyEntity(
            ...
            OnboardingBodyEntity(
              ...
              child: const Icon(BikeIcons.close),
              isInfo: false,
            ),
            OnboardingBodyEntity(
